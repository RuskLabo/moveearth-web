...
:::tip[コアへの直撃には2.5倍が付きます]
重砲弾が**露出した領土コアそのものへ点着弾**すると、既定2.5倍の直撃倍率が付きます。
**爆風範囲に入っただけでは付きません。** 車両コアとプレイヤーにも付きません。

つまり外殻を開けたあとは、重砲を正しい射線へ運んでコアへ直撃させるのが最も効率的です。
[車両コア](../../reference/vehicle-core/)が射線を作るための道具になるのはこのためです。
:::
