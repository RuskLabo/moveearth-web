...
:::note[相手が領土内で手を動かしている間、30分は減りません]
攻撃側の誰かが防衛側の領土内にいて、**直近2分以内に何かをしていれば**、
ローリングSiegeの残り時間は止まります。壁を殴っていなくても、
掘っている・撃ち合っているなら包囲は続いている、という扱いです。

数えるのは**ブロックを壊す・殴る・殴られる**の3つです。**立っているだけでは止まりません。**
1人が居座って戦争を固定することはできないようにしてあります。
...
stateDiagram-v2
    ...
    rolling --> rolling : 敵が領土内で活動中は減らない（累計4開放時間まで）
    rolling --> [*] : 30分 途絶で終了
```
